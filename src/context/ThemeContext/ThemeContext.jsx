...
const colorTheme = {
  ...
  blueTheme: {
    ...
    secondary: "#dedcff",
    accent: "#433bff",
    lightPrimary: "rgba(0, 0, 255, 0.05)",
    bg: "rgba(0, 0, 255, 0.103)",
    sb1: "rgba(0, 0, 184, 0.4)",
    sb2: "rgba(0, 0, 184, 0.3)",
    sb3: "rgba(0, 0, 184, 0.2)",
    sb4: "rgba(0, 0, 184, 0.1)",
    sb5: "rgba(0, 0, 184, 0.05)",
  },
  redTheme: {
    mode: "light",
    text: "#060505",
